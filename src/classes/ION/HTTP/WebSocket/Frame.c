...
METHODS_START(methods_ION_HTTP_WebSocket_Frame)
...
PHP_MINIT_FUNCTION(ION_HTTP_WebSocket_Frame) {
    ion_register_class(ion_ce_ION_HTTP_WebSocket_Frame, "ION\\HTTP\\WebSocket\\Frame", ion_http_websocket_frame_init, methods_ION_HTTP_WebSocket_Frame);
    ion_init_object_handlers(ion_oh_ION_HTTP_WebSocket_Frame);
    ion_oh_ION_HTTP_WebSocket_Frame.free_obj = ion_http_websocket_frame_free;
    ion_oh_ION_HTTP_WebSocket_Frame.offset = ion_offset(ion_http_websocket_frame);

    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OP_CONT",  WS_OP_CONTINUE);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OP_TEXT",  WS_OP_TEXT);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OP_BINARY",   WS_OP_BINARY);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OP_CLOSE", WS_OP_CLOSE);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OP_PING",  WS_OP_PING);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OP_PONG",  WS_OP_PONG);

    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "OPCODE_MASK",  WS_OP_MASK);

    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "FLAG_NONE",    0x0);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "FLAG_MASKING", WS_FIN);
    ion_class_declare_constant_long(ion_ce_ION_HTTP_WebSocket_Frame, "FLAG_FINAL",   WS_HAS_MASK);
