...
PHP_MINIT_FUNCTION(ION_Process_IPC_Message) {
    ...
    zend_declare_property_long(ion_ce_ION_Process_IPC_Message, STRARGS("type"), 0, ZEND_ACC_PUBLIC);
    ...
    zend_declare_class_constant_long(ion_ce_ION_Process_IPC_Message, STRARGS("TYPE_DATA"), ION_IPC_DATA);
    return SUCCESS;
}
