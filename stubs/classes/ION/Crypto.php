...
class Crypto {
     ...
     * Normally clients and servers will, where possible, transparently make use of RFC4507bis tickets for stateless
     * session resumption.
     *
     * @param bool $state
     *
     ...
     * @param string $local_pk   path to local private key file on filesystem in case of separate files for certificate
     *                           and private key.
     *
     * @return Crypto
     */
    ...
    /**
     * Set location of Certificate Authority file on local filesystem which should be used with the verifyPeer(true) to
     * authenticate the identity of the remote peer. If Certificate Authority file is not specified or if the
     * certificate is not found there, the directory pointed to by capath is searched for a suitable certificate.
