...
class FS {
	 ...
	 * This method avoids unnecessary data copies between userland and kernel. If sendfile is available, it uses those functions.
	 * Otherwise, it tries to use mmap (or CreateFileMapping on Windows).
	 *
