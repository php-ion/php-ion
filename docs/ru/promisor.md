...
Содержание:
* [ION\Promise](#ionpromise)
* [ION\Deferred](#iondeferred)
* [ION\Sequence](#ionsequence)
* [Цепочки](#Цепочки)
* [Аргументы в цепочках](#Аргументы-в-цепочках)
* [Корутины](#Корутины)

`PHP-ION` предоставляет удобный способ организации асинхронного кода через _промисы_.
