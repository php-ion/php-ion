...
Особую роль играет инициирующий коллбек последоательности - коллбек, который задается в конструкторе последоательности.

В отличии от других промисов последовательности могут принимать несколько входных аргументов в инициирующем коллбеке:
